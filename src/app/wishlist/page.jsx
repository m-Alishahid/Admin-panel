    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col items-end gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 bg-[#d4b26e] text-white px-3 py-1 rounded-full font-serif font-semibold hover:bg-[#b8932a] transition-colors text-xs"
                      >
        ...
        <div className="text-center mt-12">
          <Link
            href="/"
            className="inline-block bg-gray-800 text-white px-8 py-3 rounded-full font-serif font-semibold hover:bg-gray-700 transition-colors"
          >
            Continue Shopping
          </Link>
        </div>
